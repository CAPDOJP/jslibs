...
var Table=function(options){
	...
	container.off('mousedown.merge touchstart.merge').on('mousedown.merge touchstart.merge','td',function(e){
		...
		console.log(my.container.scrollLeft());
		scrollPos.x=my.container.scrollLeft();
		scrollPos.y=my.container.scrollTop();
	...
	$(window).off('mouseup.merge touchend.merge').on('mouseup.merge touchend.merge',function(e){
		...
		else
		{
			console.log(my.container.scrollLeft());
			if (
				scrollPos.x>my.container.scrollLeft()-5 &&
				scrollPos.x<my.container.scrollLeft()+5 &&
				scrollPos.y>my.container.scrollTop()-5 &&
				scrollPos.y<my.container.scrollTop()+5 &&
